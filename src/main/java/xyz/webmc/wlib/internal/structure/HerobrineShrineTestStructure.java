...
public final class HerobrineShrineTestStructure extends RelativeStructure implements GenerableStructure {
  @Override
  public boolean canGenerate(Location loc) {
    return true;
  }
  ...
  public static HerobrineShrineTestStructure getInstance() {
    return TestStructureUtil.getInstance(HerobrineShrineTestStructure.class);
  }

  static {
    TestStructureUtil.registerInstance(HerobrineShrineTestStructure.class);
  }
}
