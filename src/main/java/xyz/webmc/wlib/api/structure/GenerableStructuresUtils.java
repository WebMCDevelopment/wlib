...
public final class GenerableStructuresUtils {

	public static Location locateNearest(GenerableStructure structure, Location pos) {
		Location ret = null;
	...
	public static <T extends GenerableStructure> void generateChunk(T structure, Chunk chunk) {
	...
	public static <T extends GenerableStructure> void generateChunk(Class<T> structureClass,
												Chunk chunk) {
		if (structureClass != null) {
						generateChunk(TestStructureUtil.getInstance(structureClass), chunk);
		}
	}

	private static Location createLocation(World world, int chunkX, int chunkZ) {
