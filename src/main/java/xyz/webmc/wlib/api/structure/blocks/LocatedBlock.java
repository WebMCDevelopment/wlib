...
public class LocatedBlock extends AbstractBlockBase {
  private final Location loc;

  public LocatedBlock(Location loc, XMaterial mat, String dataModern, byte dataLegacy) {
    super(mat, dataModern, dataLegacy);
    this.loc = loc;
  }

  public LocatedBlock(int x, int y, int z, XMaterial mat) {
    this(new Location(null, x, y, z), mat, null, (byte) 0);
  }

  public LocatedBlock(int x, int y, int z, Material mat) {
    this(x, y, z, XMaterial.matchXMaterial(mat));
  }

  public LocatedBlock(int x, int y, int z, XMaterial mat, String dataModern) {
    this(new Location(null, x, y, z), mat, dataModern, (byte) 0);
  }

  public LocatedBlock(int x, int y, int z, Material mat, String dataModern) {
    this(x, y, z, XMaterial.matchXMaterial(mat), dataModern);
  }

  public LocatedBlock(int x, int y, int z, XMaterial mat, byte dataLegacy) {
    this(new Location(null, x, y, z), mat, null, dataLegacy);
  }

  public LocatedBlock(int x, int y, int z, Material mat, byte dataLegacy) {
